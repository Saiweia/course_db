...
class Category extends \AppBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'courses', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'name'];
        }
    ...
    public function addCourse(\AppBundle\Entity\Course $courses)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addCourse', [$courses]);
    ...
    public function removeCourse(\AppBundle\Entity\Course $courses)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeCourse', [$courses]);
