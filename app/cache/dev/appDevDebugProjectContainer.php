...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.navigationmanager' => 'getApp_NavigationmanagerService',
            ...
            'monolog.handler.rotating' => 'getMonolog_Handler_RotatingService',
            ...
            'my_formatter' => 'getMyFormatterService',
    ...
    /**
     * Gets the 'app.navigationmanager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Util\NavigationManager A AppBundle\Util\NavigationManager instance.
     */
    protected function getApp_NavigationmanagerService()
    {
        return $this->services['app.navigationmanager'] = new \AppBundle\Util\NavigationManager($this->get('doctrine.orm.default_entity_manager'), $this->get('session'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'course_db', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e3f89d31501812a1f57e5db57a361ba058468a3df3677f7df71ac4819f4dd54e');
    ...
    {
        return $this->services['monolog.handler.grouped'] = new \Monolog\Handler\GroupHandler(array(0 => $this->get('monolog.handler.rotating'), 1 => $this->get('monolog.handler.buffered')), true);
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\FingersCrossedHandler($this->get('monolog.handler.grouped'), 100, 0, true, true, NULL);
    }

    /**
     * Gets the 'monolog.handler.rotating' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getMonolog_Handler_RotatingService()
    {
        $this->services['monolog.handler.rotating'] = $instance = new \Monolog\Handler\RotatingFileHandler(($this->targetDirs[2].'\\logs/dev.log'), 10, 100, true, NULL);
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Symfony\Bridge\Monolog\Handler\SwiftMailerHandler A Symfony\Bridge\Monolog\Handler\SwiftMailerHandler instance.
     */
    ...
    /**
     * Gets the 'my_formatter' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Monolog\Formatter\JsonFormatter A Monolog\Formatter\JsonFormatter instance.
     */
    protected function getMyFormatterService()
    {
        return $this->services['my_formatter'] = new \Monolog\Formatter\JsonFormatter();
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k->setOptions(array('login_path' => 'login', 'default_target_path' => 'app_user_showCoursesByUserId', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('sylvia.klatt@gmail.com');
        $a->setPassword('w3fl9mnb');
        $a->setAuthMode('login');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('aaa07ee27d4127e02a22d24a1d8fd9d27e1d1f48');
    }
    ...
    {
        return $this->services['monolog.handler.swift.mail_message_factory'] = new \Symfony\Bundle\MonologBundle\SwiftMailer\MessageFactory($this->get('swiftmailer.mailer.default'), 'sylvia.klatt@gmail.com', array(0 => 'sylvia.klatt@gmail.com'), 'Website Error', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_user' => 'sylvia.klatt@gmail.com',
            'mailer_password' => 'w3fl9mnb',
            'secret' => 'aaa07ee27d4127e02a22d24a1d8fd9d27e1d1f48',
            'locale' => 'en',
            ...
            'kernel.secret' => 'aaa07ee27d4127e02a22d24a1d8fd9d27e1d1f48',
            ...
            'security.access.denied_url' => 'index',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'sylvia.klatt@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'w3fl9mnb',
